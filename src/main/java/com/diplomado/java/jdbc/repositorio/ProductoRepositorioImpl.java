package com.diplomado.java.jdbc.repositorio;
...
public class ProductoRepositorioImpl implements Repositorio<Producto>{
    ...
    public Producto guardar(Producto producto) throws SQLException{
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)){
            ...
            if (producto.getId() != null && producto.getId()>0) stmt.setLong(5,producto.getId());
            else stmt.setDate(5,new Date(producto.getFechaRegistro().getTime()));
            stmt.executeUpdate();
